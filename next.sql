CREATE DATABASE  IF NOT EXISTS `nextgenDB` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `nextgenDB`;
-- MySQL dump 10.13  Distrib 5.7.9, for linux-glibc2.5 (x86_64)
--
-- Host: localhost    Database: nextgenDB
-- ------------------------------------------------------
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `post_BINS` BEFORE INSERT ON `post` FOR EACH ROW
BEGIN
  DECLARE next_id INT;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `post_AINS` AFTER INSERT ON `post` FOR EACH ROW
begin
...
--
-- Dumping events for database 'nextgenDB'
--

--
-- Dumping routines for database 'nextgenDB'
--
...
-- Dump completed on 2016-11-05 14:08:11
