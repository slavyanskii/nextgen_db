...
public class Thread {
    ...
    public Thread(int id, String forum, String message, String slug, String title, Object user, String date,
    ...
    public Thread(String forum, String message, String slug, String title, Object user, String date,
