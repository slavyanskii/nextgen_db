...
public class User {
    ...
    public User(int id, String email, String name, String username, String about, boolean isAnonymous,
    ...
    public User(String email, String name, String username, String about, boolean isAnonymous) {
        this(-1, email, name, username, about, isAnonymous, new ArrayList<>(), new ArrayList<>(),
                new ArrayList<>());
    }
